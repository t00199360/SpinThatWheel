...
public class GoogleAdsDemoScript : MonoBehaviour
{
    ...
    {
        Debug.Log("Interstital Ad Closed~ Resetting ad counter");
        counter += 2;
    }
    ...
    private void GameOver()
    {
        ...
        {
            Console.WriteLine("interstitial did not load");
        }
        Debug.Log("destroying interstital");
        this.interstitial.Destroy();
        Debug.Log("interstital destroyed");
        UserChoseToWatchAd();
    }
